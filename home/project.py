...
This bot can help challenge your negative thoughts and help you 
identify and corerct cognitive distortions in them.
...
def run_bias_cycle(node,name):
    ...
    with open(CBT_FILE) as f:
        ...
        print("\nDo you want to learn more about "+str(cbt[node]['name'])+"🕵️")
        more_y_n = input('(Y/N) ?: ')
        if more_y_n.lower()=='y':
...
def show_analysis(name):
    ...
    with open(ANALYTICS_FILE) as f:
        ...
        effectiveness *= 100
        enter = input("Do you want to know something interesting about how I am helping?\n")
